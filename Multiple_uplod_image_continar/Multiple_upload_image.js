    ...
    <View
      ...
      <View
        ...
        <Text
          ...
          Show Your Guest What Your Place Look Like !
        </Text>
        ...
        <Pressable
          onPress={() => {
            setopen_modal({open_modal_view: true});
          }}
          style={{
            height: 180,
            width: 180,
          ...
          <Image
            resizeMode="contain"
            source={{
              uri: `https://flexrental.dev-hi.xyz/static/media/hotel.b7bebb584278cf86200a.jpg`,
            }}
            style={{width: '100%', height: '100%', borderRadius: 100}}
          />
          {/* } */}
      ...
      <View
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Iconfile name="file" size={23} color="white" />
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => {
              handleDocumentSelection();
            ...
            <Iconpng name="file-jpg-box" size={35} color="white" />
          </TouchableOpacity>
        </View>
        <TouchableOpacity
          disabled={disible}
          onPress={() => {
            navigation.navigate('Tittle');
          }}
      ...
      <Modal
        // animationType="fade"
        transparent
        visible={open_modal.open_modal_view}
        onRequestClose={() => {
          setopen_modal({open_modal_view: false});
        }}>
        <BlurView
        ...
        <Pressable
          ...
          <View
            style={{width: Dimensions.get('window').width / 1, height: '40%'}}>
            <Image
              resizeMode="contain"
              source={{
                uri: `https://flexrental.dev-hi.xyz/static/media/hotel.b7bebb584278cf86200a.jpg`,
