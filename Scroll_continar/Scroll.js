...
const Payment_screen = ({route, navigation}) => {
  ...
  /> */}
      ...
      <Modal
        // animationType="slide"
        transparent
        visible={open_modal.open_modals}
        onRequestClose={() => {
          setopen_modal({open_modals: false});
        }}>
                            ...
                            <>
                              <TouchableOpacity
                                ...
                                style={{
                                  ...
                                  width: '30%',
                                  backgroundColor:
                                    index == select ? '#eff3f1' : white_color,
                                  // flexDirection: 'row',
                                  // alignItems: 'center',
                                  justifyContent: 'space-between',
                                  // width:'100%',
                                  ...
                                  borderRadius: 8,
                                  borderColor:
                                    index == select ? 'black' : white_color,
                                  shadowColor: 'black',
                                  shadowOffset: {width: 1, height: 1},
                                  shadowOpacity: 0.5,
                                  // shadowRadius: ,
                                ...
                                <Iconcard
                                  ...
                                  style={{margin: 5}}
                                />
                                <Text style={{color: iten.color, margin: 5}}>
                                  {iten.title}
                                </Text>
                              </TouchableOpacity>
                            </>
...
size={18} color="white"  /> */}
                          ...
                          <Text
                            ...
                            Save this crad for future flex rental payment
                          </Text>
                        </View>
                      </View>
                      <View
      ...
      <Modal
        animationType="slide"
        transparent
        visible={open_modal_2.open_modals_2}
        onRequestClose={() => {
          setopen_modal_2({open_modals_2: false});
        }}>
        <View
