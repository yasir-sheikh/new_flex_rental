...
const Tittle_2 = ({navigation,...props}) => {
  ...
  const [disible,setdisible]=useState(true)
    ...
    return(
       ...
       }}>Let Describe Your Place Description</Text>
       <Text style={{
        fontSize:Dimensions.get("window").width/20,
       fontWeight:"900",color:blue_color,margin:10

       }}>Create Your Description</Text>
        </View>
        <View  style={{
            width:"90%",
...
size={45} color={"white"}  /> 
        ...
        <TouchableOpacity
        disabled={disible}
         onPress={()=>{navigation.navigate("Let_price")}}
        style={{height:"85%",width:"25%",backgroundColor:"black"
        ,alignItems:"center",
        justifyContent:"center",
        // borderWidth:1,borderColor:  white_color,
