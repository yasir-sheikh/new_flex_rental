...
const Profile_main = ({navigation, ...props}) => {
  ...
  const profiles = obj => {
    ...
    fetch(`https://flexrental.dev-um.xyz/api/profile/update`, {
      method: 'POST',
      // mode: 'no-cors',
    ...
    <View
      ...
      <View
        ...
        <View
          ...
          <Text
            ...
            First Name,s profile
          </Text>
        </View>
        <TouchableOpacity
          style={{width: '95%', height: '22%', justifyContent: 'center'}}
          onPress={() => {
            props.removeImage();
          }}>
          {save ? (
      ...
      <View
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => {
              navigation.navigate('Personal_infoo');
            }}>
            <Text
              style={{
                color: white_color,
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text
              ...
              Won to become a Host? Click Here
            </Text>
          </TouchableOpacity>
        </View>
        <View
        ...
        <View
          ...
          <Text
            ...
            Thrms and Condition/Privacy Polacy
          </Text>
        </View>
        <View
          style={{
        ...
        >
          ...
          <Pressable
            ...
            <View
              ...
              <Text
                style={{color: '#eb144c', fontWeight: '900'}}
                onPress={() => {
                  logout();
                }}>
                CONFROM DELETE{' '}
