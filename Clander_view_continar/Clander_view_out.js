...
const  Clander_view_out =({route,navigation})=>{
...
<CalendarPicker
        ...
        textStyle={{
          ...
          enableDateChange={true}
              onDateChange={e => {
             dispatch_date(save_date_pikar_out(e.format('YYYY-MM-DD')))   
          }}/>
    ...
    borderColor:white_color
        ...
        <Text  style={{color:white_color
            ,fontWeight:"900"}}>Date Out Done</Text>
    </TouchableOpacity>
...
export default Clander_view_out