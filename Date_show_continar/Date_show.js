  ...
  const [up_date_state_date, setup_date_state_date] = useState(false);
    ...
    { up_date_state_date_out ?
        <Text style={{
           ...
           }}>Date {save_date_redux_out_2}</Text>:
        <Text style={{
            fontSize:Dimensions.get("window").width/23,
           fontWeight:"900",color:white_color,
        ...
        //    borderWidth:2,
            ...
            <View style={{height:"14%",width:"100%",backgroundColor:"black"
        ,alignItems:"center",
        justifyContent:"center",
...
<TouchableOpacity
        // disabled={disible}
         onPress={()=>{navigation.navigate("Clander_view")}}
...
<Text style={{fontWeight:"bold",color:white_color}}> Check In Date</Text>
        </TouchableOpacity>
        <TouchableOpacity
        // disabled={disible}
         onPress={()=>{navigation.navigate("Clander_view_out")}}
        style={{height:"70%",width:"40%",backgroundColor:"black"
        ,alignItems:"center",
        justifyContent:"center",
        borderWidth:1,borderColor: white_color,
...
<Text style={{fontWeight:"bold",color:white_color}}>Check Out Date</Text>
        </TouchableOpacity>
        </View>
...
<View        style={{height:"25%",width:"80%",backgroundColor:"black"
        ,alignItems:"center",
        justifyContent:"center",
        // borderWidth:1,borderColor:  white_color,
