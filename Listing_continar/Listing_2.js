  ...
  const box_data = [
    {
      ...
      title: 'A Entir Place ',
      completed: false,
      url: 'https://flexrental.dev-hi.xyz/static/media/bedroom.cdffd9acb899230b369f.jpg',
    },
    {
      userId: 1,
      id: 2,
      ...
      completed: false,
      url: 'https://flexrental.dev-hi.xyz/static/media/place.3f171ddb6b0cd2515006.jpg',
    },
  ];
          ...
          <View
            ...
            <View
              ...
              <Text
                ...
                2. What Kind Of Space Will Guest Have ?
              </Text>
            </View>
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate('Map_Adress');
                }}
                disabled={ondesiled}
                style={{
                  height: '62%',
