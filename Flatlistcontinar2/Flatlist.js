...
import {Image_url, base_url} from '../BaseUrl/base_url';

const Flatlists = ({item, navigation}) => {
  // const items = useSelector(state => state.authReducer.item_data);
  // console.log(item.cover_photo,"................reduxxxxxxxxxxxx.")
  ...
  return (
    <>
      <View
        ...
        <Pressable
          onPress={() => {
            navigation.navigate('Imageview2', {item});
          }}
          style={{
          ...
          <Image
            resizeMode="cover"
            source={{uri: `${Image_url}/${item.cover_photo}`}}
